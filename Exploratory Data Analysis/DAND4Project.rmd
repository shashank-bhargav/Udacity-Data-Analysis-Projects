...
# Load the Data
setwd("/home/danny/Documents/DANDP4")
# Load the Data
...
geom_histogram(colour="black", fill="#ff9dab", binwidth = 1)+
                scale_x_continuous()+
...
qplot(redwine$rating, xlab="quality", fill = "#ffb6c1")
```
# Univariate Analysis
...
ggplot(aes(x = rating, y = alcohol, fill = rating), data = redwine) +
  geom_boxplot() +
  stat_summary(fun.y = median, geom = 'point', shape = 4) +
